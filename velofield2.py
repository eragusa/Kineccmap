...
Dvphi_vphi_matr=gv.plan2matr((vphisim-vphi)/vmodplan,nx,ny,selectxya)
...
plt.title('$(v_{\\theta,{\\rm sim}}-v_\\theta)/v_{\\theta,{\\rm circ}}$')
#plt.axis('equal')
plt.xlabel('$x$')
plt.ylabel('$y$')
...
Dvphi_press_vphi_matr=gv.plan2matr((vphisim-vphi_press)/vmodplan,nx,ny,selectxya)
...
plt.title('$(v_{\\theta,{\\rm sim}}-v_{\\theta,{\\rm P}})/v_{\\theta,{\\rm circ}}$')
#plt.axis('equal')
plt.xlabel('$x$')
plt.ylabel('$y$')
...
Dvphi_circ_vphi_matr=gv.plan2matr((vphisim-vmodplan)/vmodplan,nx,ny,selectxya)
...
plt.colorbar()
#plt.tricontour(xgrplan,ygrplan,(vphisim-vphi_press)/vphi,levels=20, linewidths=0.5, colors='k')
plt.title('$(v_{\\theta,{\\rm sim}}-v_{\\theta,{\\rm circ}})/v_{\\theta,{\\rm circ}}$')
#plt.axis('equal')
plt.xlabel('$x$')
plt.ylabel('$y$')
...
vphimax=1#vphi.max()
velmax=1.#(vphi-vphisim).max()*0.9
velmin=-velmax
plt.figure(322)
#plt.scatter(xgrplan,ygrplan,c=(vphisim-vphi_press)/vphi,cmap="RdBu_r",vmin=velmin/vphimax,vmax=velmax/vphimax)
vphi_press_vphi_matr=gv.plan2matr((vphi),nx,ny,selectxya)
plt.pcolormesh(x,y,vphi_press_vphi_matr,cmap="RdBu_r",vmin=velmin,vmax=velmax)
plt.axis('equal')
plt.xlim([x_min,x_max])
plt.ylim([y_min,y_max])
plt.colorbar()
#plt.tricontour(xgrplan,ygrplan,(vphisim-vphi_press)/vphi,levels=20, linewidths=0.5, colors='k')
plt.title('$(v_{\\phi,{\\rm sim}}-v_{\\phi,{\\rm press}})$')
#plt.axis('equal')
plt.xlabel('$x$')
plt.ylabel('$y$')
plt.savefig(folderres+'/vphi_press.'+img,dpi=400)
...
plt.figure(323)
#plt.scatter(xgrplan,ygrplan,c=(vphisim-vphi_press)/vphi,cmap="RdBu_r",vmin=velmin/vphimax,vmax=velmax/vphimax)
vphi_press_vphi_matr=gv.plan2matr((vphisim),nx,ny,selectxya)
plt.pcolormesh(x,y,vphi_press_vphi_matr,cmap="RdBu_r",vmin=velmin,vmax=velmax)
plt.axis('equal')
plt.xlim([x_min,x_max])
plt.ylim([y_min,y_max])
...
plt.xlabel('$x$')
plt.ylabel('$y$')
plt.savefig(folderres+'/vphi_sim.'+img,dpi=400)
...
velmin=-velmax
plt.figure(441)
#Dvr_vphi_matr=gv.plan2matr((vrsim-vr)/(np.max(e(a))*gv.Omega0(a)*a)*(np.sqrt(1-np.max(e(a))**2)),nx,ny,selectxya)
Dvr_vphi_matr=gv.plan2matr((vrsim-vr)/(0.25*vmodplan),nx,ny,selectxya)
...
plt.xlabel('$x$')
plt.ylabel('$y$')
#plt.title('$(v_{R,sim}-v_R)/v_{R}(e_{\\rm max})$')
plt.title('$(v_{R,sim}-v_{R,{\\rm theor}})/(e_{\\rm cav}v_{\\theta,{\\rm circ}})$')
...
velmin=-velmax
plt.figure(442)
Dvr_circ_vphi_matr=gv.plan2matr((vrsim)/(0.25*vmodplan),nx,ny,selectxya)
plt.pcolormesh(x,y,Dvr_circ_vphi_matr,cmap="RdBu_r",vmin=velmin,vmax=velmax)
#plt.scatter(xgrplan,ygrplan,c=(vrsim-vr)/vphi,cmap="RdBu_r",vmin=velmin/vrmax,vmax=velmax/vrmax)
plt.colorbar()
#plt.tricontour(xgrplan,ygrplan,(vr-vrsim)/vphi,levels=20, linewidths=0.5, colors='k')
plt.axis('equal')
...
plt.xlabel('$x$')
plt.ylabel('$y$')
plt.title('$(v_{R,sim}-v_{R,{\\rm circ}})/(e_{\\rm cav}v_{\\theta,{\\rm circ}})$')
...
vmax=3.14
vmin=-3.14
#the annulus with 3.14 as a value, implies that the maximum compression is at apocentre.
