...
vzm=np.loadtxt(name+'_vz_proj.pix')
...
plt.plot(radii,e(radii),label='interpolation')
plt.xlabel('$a$')
plt.ylabel('$e$')
plt.xlim([2,13])
plt.legend()
...
plt.plot(radii,np.arctan2(sinvarpi(radii),cosvarpi(radii)),label='interpolation')
plt.xlabel('$a$')
plt.ylabel('$\\varpi$')
plt.xlim([2,13])
plt.legend()
...
plt.plot(radii,sigma_a(radii),label='interpolation')
plt.xlabel('$a$')
plt.ylabel('$\\Sigma$')
plt.xlim([2,13])
plt.legend()
