...
folderres=up.folderres+'/inclined_theor_30/'
name=sys.argv[1]
...
corrector=2.5#3.5#corrector for matching the last emission surface in units of H
...
vv=np.array([v0v[0,:]*rescale_v2,v0v[1,:]*rescale_v2,np.nan_to_num(vz*corrector,posinf=0.,neginf=0.)])*rescale_v
vvbottom=np.array([v0v[0,:]*rescale_v2,v0v[1,:]*rescale_v2,np.nan_to_num(-vz*corrector,posinf=0.,neginf=0.)])*rescale_v
...
vvsim=np.array([vxplan,vyplan,np.nan_to_num(vzplan*corrector,posinf=0.,neginf=0.)])*rescale_v
vvsimbottom=np.array([vxplan,vyplan,np.nan_to_num(-vzplan*corrector,posinf=0.,neginf=0.)])*rescale_v

#the 0.8 to account for factor sqrt(2/pi)
vvpress=np.array([vx_press,vy_press,np.nan_to_num(vz*corrector,posinf=0.,neginf=0.)])*rescale_v
vvpressbottom=np.array([vx_press,vy_press,np.nan_to_num(-vz*corrector,posinf=0.,neginf=0.)])*rescale_v
...
sumreslast=sumres(residuals_circ)
print('Residuals sim-circmodel:',sumreslast)
