...
print('x of 239,353 is:',xgr[239,353])
print('y of 239,353 is:',ygr[239,353])

plt.plot(vvec,data[:,239,353])
plt.xlim([-1.,3.])
#plt.ylim([0,3.])
...
plt.savefig('/Users/enricoragusa/Works/eccMap/'+folder+'/mcfost_RT/30deg/spectrum_pixel.png')
